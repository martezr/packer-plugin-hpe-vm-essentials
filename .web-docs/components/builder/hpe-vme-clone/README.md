...
<!-- Code generated from the comments of the Config struct in builder/hpe-vme/clone/config.go; DO NOT EDIT MANUALLY -->
...
<!-- End of code generated from the comments of the Config struct in builder/hpe-vme/clone/config.go; -->
...
<!-- Code generated from the comments of the StorageVolume struct in builder/hpe-vme/clone/config.go; DO NOT EDIT MANUALLY -->
...
<!-- End of code generated from the comments of the StorageVolume struct in builder/hpe-vme/clone/config.go; -->
...
<!-- Code generated from the comments of the NetworkInterface struct in builder/hpe-vme/clone/config.go; DO NOT EDIT MANUALLY -->

- `network_id` (int64) - Network Id

- `network_interface_type_id` (int64) - Network Interface Type Id

<!-- End of code generated from the comments of the NetworkInterface struct in builder/hpe-vme/clone/config.go; -->
